<?php
	...
	function ppf_css(){
		...
		wp_enqueue_script('Scroll', get_template_directory_uri() .'/js/jquery.scrollTo.js','','', false);
	}
	add_action('wp_enqueue_scripts', 'ppf_css');
	...
	function ppf_setup(){
		...
		add_image_size('who-thumbnail', 247, 247, true);
		add_image_size('project-thumbnail', 350, 250, true);
